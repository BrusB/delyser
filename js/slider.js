class TeamSlider {
    ...
    getCardsPerView() {
        ...
        const cardWidth = 300; // Ancho m�nimo de cada tarjeta
    ...
    createDots() {
        ...
        // Crear un dot por cada "p�gina" del slider
    ...
    updateSlider() {
        ...
        // Los botones siempre est�n habilitados para comportamiento circular
    ...
    handleResize() {
        ...
        // Recrear dots si cambi� el n�mero de p�ginas
...
// Inicializar el slider cuando se carga la p�gina
